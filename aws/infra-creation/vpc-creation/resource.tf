...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "terraform-vpc-public-${each.key}"
    Env = "Dev"
    Purpose = "Expose the service to outside world"
    Placement = "public"
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "terraform-vpc-private-${each.key}"
    Env = "Dev"
    Purpose = "Expose the service to outside world"
    Placement = "public"
...
resource "aws_subnet" "db_private" {
  ...
  tags = {
    Name = "terraform-vpc-db-private-${each.key}"
    Env = "Dev"
    Purpose = "Expose the service to outside world"
    Placement = "public"
...
resource "aws_nat_gateway" "ngw" {
  ...
  tags = {
    Name = "terraform-vpc-nat-gateway"
  }
